                                ...
                                <div className="flex h-16 items-center justify-between">
                                    ...
                                    <div className="hidden md:block">
                                        <div className="ml-4 flex items-center md:ml-6">
                                            {/* Legördülő menü */}
                                            <div className="text-lg font-medium leading-none text-white">{getCurrentUser().name}</div>
                                            <Menu as="div" className="relative ml-3">
                                                <div>
                                                    <Menu.Button className="flex max-w-xs items-center rounded-full bg-gray-800 text-base focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
